...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StatSet'
        db.create_table(u'mls_api_statset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('attempts_on_goal', self.gf('django.db.models.fields.IntegerField')()),
            ('shots_on_target', self.gf('django.db.models.fields.IntegerField')()),
            ('shots_off_target', self.gf('django.db.models.fields.IntegerField')()),
            ('blocked_shots', self.gf('django.db.models.fields.IntegerField')()),
            ('corner_kicks', self.gf('django.db.models.fields.IntegerField')()),
            ('fouls', self.gf('django.db.models.fields.IntegerField')()),
            ('crosses', self.gf('django.db.models.fields.IntegerField')()),
            ('offsides', self.gf('django.db.models.fields.IntegerField')()),
            ('first_yellows', self.gf('django.db.models.fields.IntegerField')()),
            ('second_yellows', self.gf('django.db.models.fields.IntegerField')()),
            ('red_cards', self.gf('django.db.models.fields.IntegerField')()),
            ('duels_won', self.gf('django.db.models.fields.IntegerField')()),
            ('duels_won_percentage', self.gf('django.db.models.fields.IntegerField')()),
            ('total_passes', self.gf('django.db.models.fields.IntegerField')()),
            ('pass_percentage', self.gf('django.db.models.fields.IntegerField')()),
            ('possession', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mls_api.Team'])),
            ('game', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mls_api.Game'], unique=True)),
        ))
        db.send_create_signal(u'mls_api', ['StatSet'])


    def backwards(self, orm):
        # Deleting model 'StatSet'
        db.delete_table(u'mls_api_statset')
    ...
    models = {
        ...
        u'mls_api.statset': {
            ...
            'game': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['mls_api.Game']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
