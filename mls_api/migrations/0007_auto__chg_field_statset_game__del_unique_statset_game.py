...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StatSet', fields ['game']
        db.delete_unique(u'mls_api_statset', ['game_id'])


        # Changing field 'StatSet.game'
        db.alter_column(u'mls_api_statset', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mls_api.Game']))

    def backwards(self, orm):

        # Changing field 'StatSet.game'
        db.alter_column(u'mls_api_statset', 'game_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mls_api.Game'], unique=True))
        # Adding unique constraint on 'StatSet', fields ['game']
        db.create_unique(u'mls_api_statset', ['game_id'])
