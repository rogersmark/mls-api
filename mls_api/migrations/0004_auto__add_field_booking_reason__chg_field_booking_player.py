...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.reason'
        db.add_column(u'mls_api_booking', 'reason',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


        # Changing field 'Booking.player'
        db.alter_column(u'mls_api_booking', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mls_api.GamePlayer']))

    def backwards(self, orm):
        # Deleting field 'Booking.reason'
        db.delete_column(u'mls_api_booking', 'reason')


        # Changing field 'Booking.player'
        db.alter_column(u'mls_api_booking', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mls_api.Player']))
