...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.home_score'
        db.delete_column(u'mls_api_game', 'home_score')

        # Deleting field 'Game.away_score'
        db.delete_column(u'mls_api_game', 'away_score')

        # Adding field 'Goal.own_goal'
        db.add_column(u'mls_api_goal', 'own_goal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.home_score'
        db.add_column(u'mls_api_game', 'home_score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Game.away_score'
        db.add_column(u'mls_api_game', 'away_score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Goal.own_goal'
        db.delete_column(u'mls_api_goal', 'own_goal')
